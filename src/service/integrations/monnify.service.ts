...
// import { createWallet } from "../naira-wallet.service";
// import { findAndUpdateTransaction, findTransactions } from "../transaction.service";
// import { findAndUpdate, findUser } from "../user.service";
...
//                 user: input.userId,
//                 accountReference: reservationResponse.responseBody.accountReference,
//                 reservationReference: reservationResponse.responseBody.reservationReference,
//                 accountName: reservationResponse.responseBody.accounts[0].accountName,
//                 accountNumber: reservationResponse.responseBody.accounts[0].accountNumber,
//                 bankCode: reservationResponse.responseBody.accounts[0].bankCode,
//                 bankName: reservationResponse.responseBody.accounts[0].bankName
//             })
...
// export const verifyBvn = async (input: BvnVerificationData) => {
//     try {
//         const url = `${config.monnify.BASE_URL}/api/v1/vas/bvn-details-match`
//         const verb = 'POST'

//         let bvnVerificationResponse = null;
//         const requestBody = {
//             bvn:input.bvn,
//             name: input.name,
...
//         bvnVerificationResponse = await requestPromise(requestOptions);
//         bvnVerificationResponse = parseResponse(bvnVerificationResponse);

//         if(!bvnVerificationResponse.requestSuccessful) {
//             return {
//                 error: true,
//                 errorType: 'badRequest',
//                 data: bvnVerificationResponse.responseMessage
//             }
//         } else {
//             let bvnVerified = false
//             // Save matching and bvnVerified: true|false
//             if(bvnVerificationResponse.responseBody.name.matchPercentage > 50 && bvnVerificationResponse.responseBody.dateOfBirth === 'FULL_MATCH') {
//                 bvnVerified = true
//             }
...
//                 error: false,
//                 errorType: '',
//                 data: { bvnVerified, verificationData: bvnVerificationResponse.responseBody }
//             }
//         }
